// ===========================================================================
//	UTextTraits.cp				PowerPlant 2.1		©1993-2000 Metrowerks Inc.
// ===========================================================================
//
	...
	if (ioTextTraits != nil) {
		...
		switch (ioTextTraits->fontNumber) {
			...
			case fontNumber_Unknown:
			  ...
			  // ERZ mod
			    if (ioTextTraits->fontNumber == 0) {
			        ioTextTraits->fontNumber = gGalacticaFontNum;
			    }
			  // end ERZ mod
				break;
...
#warning TODO: handle endian swap
